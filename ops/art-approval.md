...
> Note (2026-09-08): **VISUAL-REFACTOR-P0 art half-pack** approved by 幕僚长 (standing auth). Buildings (12× 48×48 powered/unpowered) + build dust FX (2× 64×64) + soil_base v3 + ore dust/shard/core set v3 drop-in for wiring. **Residuals:** (1) powered/unpowered silhouette not pixel-locked yet — especially `anchor_block`; (2) ore dust/shard/core v3 currently identical SHA-256 — differentiate in follow-up. Buildings+fx+soil+ore damage strip approved for wiring. No `.import` flood. No code.
