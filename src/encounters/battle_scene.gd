...
##
## 观感接线白名单（#36/#37/#41 v2 满 8 帧已批）：生产目录仅对 WIRED_BATTLE_UNIT_IDS
...
## Presentation-approved battle unit ids (luoxian/misa/drift via #36/#37; shard_husk via #41).
const WIRED_BATTLE_UNIT_IDS: PackedStringArray = ["luoxian_fighter", "misa_weaver", "drift_swarmling", "shard_husk"]
